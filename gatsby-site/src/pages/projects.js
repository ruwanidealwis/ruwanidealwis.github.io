            ...
            >
              <CardContent>
                ...
                <Typography variant="body1">
                  ...
                  planning on improving and expanding upon these.
                </Typography>
                <br />
                <FormControl>
                  <InputLabel htmlFor="my-input">Project Type</InputLabel>
                  <NativeSelect
                    value={
...
I love listening to music from the ’80s/70’s and I thought it would a great way to learn how similar my music tastes were to that of the mainstream hits from the past, and potentially discover some new hits.`}
                ...
                style={{ display: this.state.webDevelopment ? "" : "none" }}
              />
            </Grid>
          ) : (
            ""
          ...
          {this.state.dataScience ? (
            ...
            >
              <ProjectCard
                ...
                tagline={"Deep dive into the World Happiness Report of 2020"}
                type={"Data Science"}
                description={`
...
`}
                tools={["Pandas", "Plotly", "Seaborn", "Jupyter Notebook"]}
                githubLink={
                ...
                style={{ display: this.state.dataScience ? "" : "none" }}
              />
            </Grid>
          ) : (
            ""
...
`}
                tools={["Pandas", "Plotly", "Seaborn", "Jupyter Notebook"]}
                githubLink={"https://github.com/ruwanidealwis/tvShowAnalysis"}
          ...
          {this.state.webDevelopment ? (
            ...
            >
              <ProjectCard
                ...
                tagline={"Get a colour palette for your Spotify Playlist"}
                type={"Data Science"}
...
`}
                tools={["NodeJs", "Spotify", "ExpressJs", "Pug", "Boostrap"]}
                githubLink={
